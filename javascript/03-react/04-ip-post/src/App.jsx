...
const App = () => {
  ...
  <div className="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden">
    <img src="https://cdn-icons-png.flaticon.com/512/4359/4359919.png" alt="post-image" className="bg-orange-400 rounded-full" />
  </div>
  <div className="rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
    <div className="mb-8">
      ...
      <p className="text-gray-500 text-sm font-medium ">{post.body}</p>
    </div>
    <div>
    <button
  ...
  return (
    <div className="flex bg-orange-400">
      ...
      <div className="grid grid-cols-1 mx-auto max-w-4xl">{blogPostTemplate}</div>
