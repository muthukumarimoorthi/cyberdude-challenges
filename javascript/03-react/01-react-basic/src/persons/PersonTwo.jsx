    ...
    <section>
      <div className="max-w-2xl mx-auto bg-slate-700 rounded my-10 px-5 py-5">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-slate-300">
                      ...
                      >
                        <path
                          fill="currentColor"
                          d="M16 2a14 14 0 1 0 14 14A14.016 14.016 0 0 0 16 2M4 16a11.915 11.915 0 0 1 .7-4H10l5 4l-2.8 3.693A1 1 0 0 0 12.293 21L15 24v3.95A12.01 12.01 0 0 1 4 16m17.435 10.685l2.546-7.7a1 1 0 0 0-.367-.985L15 11l2-2h5.28a1 1 0 0 0 .948-.684l.495-1.486a11.974 11.974 0 0 1-2.288 19.855"
                        />
                      </svg>
                    </span>
                  </div>
        ...
        <div className="flex flex-col space-y-5">
          ...
          <span className="text-sm text-slate-200">
            - Clean UI based on previous version of Google Meet UI.
          </span>
          <span className="text-sm text-slate-200">💪🏽 Challenges</span>
          <div className="flex flex-col space-y-2">
            <span className="text-sm text-slate-200">
              - This is my Fourth project using the Tailwind CSS. It was easier
              than before for me to complete this task, as I was familiar with
              the Tailwind CSS because of my previous projects.
            </span>
            <span className="text-sm text-slate-200">
              - This is where I learned the core concept of the Tailwind CSS. I
              learned where I need to use Tailwind CSS and where to use the Grid
              Flex.
            </span>
            <span className="text-sm text-slate-200">
              - This was a special project to me. It’s because I built it from
              scratch. I did not get any help, I handled all the work.
            </span>
            <span className="text-sm text-slate-200">
              - Until now my mentor use to give me guidelines of the project.
              But this is the first project I completed without any help.
            </span>
            <span className="text-sm text-slate-200">
              - I know the concept of the Grid. But this is where I learned how
              does the Grid work. I have worked with Grid previously, But this
              is where I under the working of Grid.
            </span>
            <span className="text-sm text-slate-200">
              - After completion of this project I was more confident I will
              able to create an UI by myself.
            </span>
            <span className="text-sm text-slate-200">
              - As a Amateur I feel confident after the completion of this
              project. Now, I knew and having a clear understand at how Tailwind
              work with HTML.
            </span>
          </div>
