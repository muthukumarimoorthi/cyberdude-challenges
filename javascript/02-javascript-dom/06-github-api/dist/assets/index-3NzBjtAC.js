(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&l(o)}).observe(document,{childList:!0,subtree:!0});function t(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function l(e){if(e.ep)return;e.ep=!0;const r=t(e);fetch(e.href,r)}})();document.getElementById("gitHubProfile");console.log(gitHubProfile);const n=["muthukumarimoorthi","mshajid","yrd369","muthuakalya","mushkir","esakki2104prsnl","Vk2401","suriyamassmsd","riyaz1000","hema-venkat3","bearcin46","dineshdevelope","jeya-rosini","swethadsalvatore","vedhatech002","danielace1","sharif-22","gayathrihg","kishorekumar-kp"];n.forEach(s=>{const i=`https://api.github.com/users/${s}`;fetch(i).then(t=>t.json()).then(t=>{const l=document.createElement("div");l.innerHTML=`<div
    ...
    >
      ...
      <ul class="py-4 mt-2 text-gray-800 flex items-center justify-around">
        <li class="flex flex-col items-center justify-around" title="Following">
          ...
          <div title="Following">${t.following}</div>
        </li>
        <li class="flex flex-col items-center justify-between" title="Followers">
          ...
          <div title="Followers">${t.followers}</div>
        </li>
        <li class="flex flex-col items-center justify-around" title="Repositories">
          ...
          <div title="Repositories">${t.public_repos}</div>
        </li>
      </ul>
      <div class="p-4 border-t border-[#5F6F52] mx-8 mt-2">
        ...
        >
          <a href="${t.html_url}" target="_blank">Profile</a>
        </button>
      </div>
    </div>`,gitHubProfile.append(l)})});
